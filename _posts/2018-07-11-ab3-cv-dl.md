...
1. E. Ilg, N. Mayer, T. Saikia, M. Keuper, A. Dosovitskiy, and T. Brox, “FlowNet 2.0: Evolution of Optical Flow Estimation with Deep Networks,” arXiv:1612.01925 [cs], Dec. 2016.
    ...
    **FlowNet 2.0; optical flow**
    ...
    This paper built upon the previous FlowNet 1.0. The FlowNet 1.0 resolves problems with small displacements and noisy artifacts in estimated flow fields. Since all state-of-the-art optical flow approaches fely on iterative methods, the authors hypotheses that deep network may also benifit from iterative refinement. To do this, they experiment with stacking multiple FlowNetS and FlowNetC. Subseqauent networks get the input two adjacent images and the previous flow estimate as input. 
