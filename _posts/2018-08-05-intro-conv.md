...
![png](friendly_intro_to_convolution_files/friendly_intro_to_convolution_1_0.png)
...
![png](friendly_intro_to_convolution_files/friendly_intro_to_convolution_3_0.png)
...
![png](friendly_intro_to_convolution_files/friendly_intro_to_convolution_6_0.png)
...
![png](friendly_intro_to_convolution_files/friendly_intro_to_convolution_9_0.png)
...
where $n$ is the start position of $\vec{w}$ on $\vec{x}$, and $|w|$ denotes the length of $\vec{w}$. After calculating all the $y_n$ along the sequence of $\vec{x}$, we just complete the convolution operation.  
